...
const FeatureList = [
  {
    title: '零基础',
    icon: '🟢',
    description: <>无技术基础的业务人员，需单点几下即可抓取地图商家，简单易上手。</>,
  },
  {
    title: '全自动',
    icon: '🤖',
    description: <>自动打开地图并抓取，无需人工，24小时全自动运行，省时省力。</>,
  },
  {
    title: '高效率',
    icon: '⚡',
    description: <>60分钟抓取7000商家，抓取速度远超同类产品，数据获取更加高效。</>,
  },
  {
    title: '不绑定',
    icon: '🌐',
    description: <>无需绑定设备，支持在任何Chrome内核浏览器上运行，随时随地使用。</>,
  },
];
