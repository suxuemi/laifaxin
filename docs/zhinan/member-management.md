...
![组织架构邀请成员界面](https://cos.files.maozhishi.com/data/web/web-files/img/1733397590212.png)
...
- **❓ 我应该先创建部门再邀请成员，还是反过来？**
> - 答：我们建议您先在 📚[部门管理](./department-management) 中规划并创建好您的 **<span style={{color: '#8e44ad'}}>组织架构</span>**。这样，在邀请成员时，您可以直接将他们分配到预设的部门和角色中，提高效率。
